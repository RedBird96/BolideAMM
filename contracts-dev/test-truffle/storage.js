...
describe('Storage', () => {
  ...
  describe('standart scence', async () => {
    ...
    it('can not use deposit unknown token address', async () => {
      storage.deposit(1000, accounts[6], { from: Alexander }).should.be.revertedWith(`Returned error: VM Exception while processing transaction: revert E1 -- Reason given: E1.`)
    })

    it('not can used returnToken when small allowance', async () => {
      await storage.deposit(web3.utils.toWei('5', 'ether'), usdt.address, { from: Alexander }).should.be.revertedWith(`Returned error: VM Exception while processing transaction: revert ERC20: transfer amount exceeds balance -- Reason given: ERC20: transfer amount exceeds balance.`);
    })
    ...
    it('can not take token more than you have', async () => {
      await storage.takeToken(web3.utils.toWei('10', 'micro'), usdt.address, { from: logicContract }).should.be.revertedWith("Returned error: VM Exception while processing transaction: revert ERC20: transfer amount exceeds balance -- Reason given: ERC20: transfer amount exceeds balance.");
    })
    ...
    it('not can used returnToken when small allowance', async () => {
      ...
      await storage.returnToken(5000, usdt.address, { from: logicContract }).should.be.revertedWith("Returned error: VM Exception while processing transaction: revert ERC20: transfer amount exceeds balance -- Reason given: ERC20: transfer amount exceeds balance.");
    })

    it('not can used returnToken unknown token address', async () => {
      await usdt.approve(storage.address, 4000, { from: logicContract })
      await storage.returnToken(4000, accounts[6], { from: logicContract }).should.be.revertedWith("Returned error: VM Exception while processing transaction: revert E1 -- Reason given: E1.");
    })
    ...
    it('withdraw when amount more then have user', async () => {
      await storage.withdraw("999999999999999999", usdt.address, { from: Dmitry }).should.be.revertedWith("Returned error: VM Exception while processing transaction: revert E4 -- Reason given: E4.")
    })

    it('withdraw when amount equal zero', async () => {
      await storage.withdraw("0", usdt.address, { from: Dmitry }).should.be.revertedWith("Returned error: VM Exception while processing transaction: revert E4 -- Reason given: E4.")
    })

    it('withdraw when amount equal zero', async () => {
      await storage.deposit("0", usdt.address, { from: Dmitry }).should.be.revertedWith("Returned error: VM Exception while processing transaction: revert E3 -- Reason given: E3.")
    })
  ...
  describe('zero deposit one add earn', async () => {
    ...
    it('first add earn', async () => {
      ...
      startTime = startTime.add(time.duration.hours(10))
      await time.increaseTo(startTime)
      await storage.addEarn(web3.utils.toWei('1', 'micro'), { from: logicContract }).should.be.revertedWith("Returned error: VM Exception while processing transaction: revert")
    })
  })
