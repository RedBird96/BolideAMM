...
contract MultiLogic is LogicUpgradeable {
    ...
    event InitStrategy(singleStrategy[] strategies);
     ...
     */
    function initStrategy(singleStrategy[] calldata _multiStrategy)
        external
        onlyOwnerAndAdmin
    {
        delete multiStrategy;
        ...
        emit InitStrategy(_multiStrategy);
    }
