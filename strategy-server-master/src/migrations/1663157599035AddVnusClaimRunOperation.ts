...
export class AddVnusClaimRunOperation1663157599035
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "CREATE TYPE \"public\".\"operations_type_enum\" AS ENUM('STRATEGY_RUN', 'CLAIM_RUN', 'WITHDRAW_ALL_TO_STORAGE', 'VENUS_CLAIM_RUN')",
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      "CREATE TYPE \"public\".\"operations_type_enum_old\" AS ENUM('STRATEGY_RUN', 'CLAIM_RUN', 'WITHDRAW_ALL_TO_STORAGE')",
    );
    await queryRunner.query(
